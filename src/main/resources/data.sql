INSERT INTO BRND(NAME) VALUES
  ('ADIDAS'),
  ('PUMA'),
  ('NIKE'),
  ('ASICS');

  INSERT INTO CLR(NAME,CODE)  VALUES
  ('RED','RD'),
  ('GREEN','GRN'),
  ('BLUE','BLU');

  INSERT INTO PRDCT_CTGR(NAME) VALUES
  ('SHIRT'),
  ('PANT'),
  ('ACCESSORIES');

  INSERT INTO PRDCT(NAME,QUANTITY,SIZE,PRICE,BRND_ID,CLR_ID,PRDCT_CTGR_ID) VALUES
